...
//---------- XÓA DOCUMENT -----------------------------------
    ...
    let list_status_thread_download = {}
    let list_status_thread_save = {}
    let list_terminate_interval_download = {}
    let list_terminate_interval_save = {}
            ...
            $.ajax({
                ...
                let intervalId_download = setInterval(()=>{
                    if (id in list_terminate_interval_download == false) {
                        list_terminate_interval_download[id] = intervalId_download
                    }
                    if(list_status_thread_download[id] == true){
                        $.ajax({
                ...
                let intervalId_save = setInterval(()=>{
                    if (id in list_terminate_interval_save == false) {
                        list_terminate_interval_save[id] = intervalId_save
                    }
                    if(list_status_thread_save[id] == true){
                        $.ajax({
...
//------------ TÙY CHỌN XÓA NGUỒN ---------------------------
    ...
    $(document).on('click', '.btn-pause-thread', e=>{
        ...
        $.ajax({
            ...
            list_status_thread_download[thread_name] = false
            list_status_thread_save[thread_name] = false
            console.log('status save: ' + list_status_thread_save)
            console.log('status download: ' + list_terminate_interval_download)
        })
    })
    // resume
    $(document).on('click', '.btn-resume-thread', e=>{
        ...
        $.ajax({
            ...
            list_status_thread_download[thread_name] = true
            list_status_thread_save[thread_name] = true
    ...
    $(document).on('click', '.btn-stop-thread', e=>{
        ...
        $.ajax({
            ...
            clearInterval(list_terminate_interval_download[thread_name])
            clearInterval(list_terminate_interval_save[thread_name])
        })
    })
